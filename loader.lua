...
local games = {
	{ name = "ValoBlox", link = "loadstring(game:HttpGet("https://raw.githubusercontent.com/zxbnz/Valolo-Blox/refs/heads/main/code"))()"},
	{ name = "Operation Siege", link = "loadstring(game:HttpGet("https://raw.githubusercontent.com/zxbnz/OS-Cheat/refs/heads/main/code"))()" },
	{ name = "Jailbird", link = "loadstring(game:HttpGet("https://raw.githubusercontent.com/zxbnz/JailBird-Cheat/refs/heads/main/code"))()"},
    { name = "Frontlines" },
	{ name = "Scorched Earth"},
};
